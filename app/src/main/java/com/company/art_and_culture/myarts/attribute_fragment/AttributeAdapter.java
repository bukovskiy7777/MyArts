...
public class AttributeAdapter extends PagedListAdapter<Attribute, AttributeAdapter.AttributeViewHolder> {
    ...
    public AttributeAdapter(Context context, OnAttributeClickListener onAttributeClickListener, int displayWidth, int displayHeight, int spanCount) {
    ...
    public interface OnAttributeClickListener {
        void onAttributeClick(Attribute attribute, int position);
    }
    ...
    class AttributeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        AttributeViewHolder(@NonNull View itemView) {
            super(itemView);
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == attribute_image.getId()) {
                onAttributeClickListener.onAttributeClick(attribute, position);
            }
        }
