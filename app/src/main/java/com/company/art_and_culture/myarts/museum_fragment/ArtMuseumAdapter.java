...
public class ArtMuseumAdapter extends PagedListAdapter<Art, ArtMuseumAdapter.ArtMuseumViewHolder> {
    ...
    public ArtMuseumAdapter(MuseumViewModel museumViewModel, Context context, OnArtClickListener onArtClickListener, int displayWidth, int displayHeight, int spanCount) {
        super(itemDiffUtilCallback);
        this.context = context;
        this.museumViewModel = museumViewModel;
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull ArtMuseumViewHolder holder) {
        super.onViewAttachedToWindow(holder);
        holder.onAttached();
    }

    @Override
    public void onViewDetachedFromWindow(@NonNull ArtMuseumViewHolder holder) {
    ...
    @NonNull
    @Override
    public ArtMuseumViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_art_museum, parent, false);
        return new ArtMuseumViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ArtMuseumViewHolder holder, int position) {
    ...
    class ArtMuseumViewHolder extends LifecycleViewHolder implements View.OnClickListener {
        ...
        private final Target target = new Target() {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                ...
                museumViewModel.writeDimentionsOnServer(art);
        ...
        ArtMuseumViewHolder(@NonNull View itemView) {
            super(itemView);
